...
---
**Dia 32<br>19 de Maio de 2022**<br>*275 minutos de estudo*

> *Project 7-3 - Fiftyville*

* **[CS50x] - HTML & CSS & JavaScript**<br>*Ideias importantes*<br>Server router -> É o responsável por receber e enviar informações. // TCP/IP - Protocols. Estão estruturados e organizados para agirem conforme um algoritmo. Fragmentação de dados (tudo ou nada) que são muito grandes para que um número maior de informações de outros usuários possam ser enviados simultaneamente. // Endereço de IP -v4 usa 4 bytes de possíveis endereços; Ip -v6 usa 6 bytes; // TCP (**port** number) - Especifica o servidor ou serviço que a informação está sendo enviada ou recebida. // UDP outro procotocolo que substitui o TCP [Transmission Control Protocol] // Domain name - DNS (Domain Name System) - DNS server (Hash table - Key-> domain name ; Value-> IP [Internet Protocol] - x.y.z.w [0~255] - Total 4kkk -- IPv6 - 8 Cluster e 16 bits) / HTTP (Hypertext Transfer Protocol) - Protocolo que organiza a comunicação entre o browser com o server // HTTPS - plus Secure. Define como deve ser obtido e enviado informações a um servidor. // www - Subdomain or host name / com - Top domain // Get - Coloca as informações do usuário na URL & Post - Esconde informações da URL // Request & Response -- Client & Server // MIMES type - html/text or img/png // 200 - OK / 403 - ERROR 404 / 500 - Internal Server Error // Phishing attack - Usar o \<a href> de uma forma maliciosa // Inheritance (CSS) - Os filhos adotam os atributos estiuplados nos pais. // type selector or class selector or ID selector or attribute selector // < link href="nameCss.css" rel="Stylesheet"> Usar depois de criar classes num outro arquivo. // Bootstrap - Framework para usar como web developer. // DOM Document Object Model  (== tree ) <script> // DHCP server (Dynamic Host Configuration Protocol) - Fornece um IP para cada máquina // Access point -x   O papel do router de ser o interceptor de informações que são enviadas de uma rede particular com vários aparelhos para a internet. Portanto, a comunicação é feita usando como iintermediário o router e não o computador per se. WANS - Wide-area newtowrks // Inter-net - Inter Connected Network // Router auxilia fazer a distribuição do networking. Eles sinalizam o caminho para acessar uma determinada rede.
  
 ---
 **Dia 33<br>20 de Maio de 2022**<br>*375 minutos de estudo*
...
---
**Dia 37<br>24 de Maio de 2022**<br>*300 minutos de estudo*
...
---
**Dia 38<br>25 de Maio de 2022**<br>*100 minutos de estudo*
* **[FreeCodeCamp] - Responsive Web Design**
  
---
**Dia 39<br>26 de Maio de 2022**<br>*250 minutos de estudo*
* **[FreeCodeCamp] - Responsive Web Design**
...
---
**Dia 43<br> 01 de Junho de 2022**<br>*325 minutos de estudo*
